...
const deletePhotoFromServer = async (photo) => {
  ...
  const path = `${__dirname}/../public/img/tours/${photo}`;
...
exports.updateTourImages = catchAsync(async (req, res) => {
  if (req.query.editTourImages) {
    ...
    if (req.files.imageCover) {
      await deletePhotoFromServer(tour.imageCover);
    }
  }
